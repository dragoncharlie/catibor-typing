...
const EmailFinish = ({
	stat: { accuracy, time, cpm, wpm, errors },
	onRestart,
}: EmailFinishProps) => {
	return (
		<div className='flex flex-col m-auto p-16 max-w-[320px] w-full items-center'>
			<p className='mb-24 text-18 text-center'>
				Meooowray, <br /> the e-mail's been sent!
			</p>
			...
			<button className='button mt-24 w-full' onClick={onRestart}>
